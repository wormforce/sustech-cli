...
export const CONSEQUENCES: readonly Consequence[] = [
  ...
  consequence("blackboard.attempt-download", "low", true, "Writes one selected file from a Blackboard assignment attempt to an explicit local path.", "A wrong destination, combined with --overwrite, can replace an existing local file.", "Use the returned absolute path, byte count, and SHA-256 to verify the saved file.", "implemented"),
  ...
  consequence("blackboard.message-send", "high", false, "Creates one Blackboard course message for the selected recipients in a specific course.", "A wrong course, recipient set, subject, or body can notify unintended classmates or staff.", "Read the created message back and match the exact message ID, recipients, subject, and body.", "implemented"),
  consequence("blackboard.discussion-post", "high", false, "Creates one Blackboard discussion message in a specific course forum.", "A wrong discussion, group, or message body can become visible to classmates or staff.", "Read the created discussion message back and match the exact message ID, body, and status.", "implemented"),
  consequence("blackboard.discussion-reply", "high", false, "Creates one Blackboard reply under a specific discussion message.", "A wrong reply target or body can notify or mislead other course participants.", "Read the created reply back and match the exact reply ID, parent message ID, body, and status.", "implemented"),
