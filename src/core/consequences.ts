...
export const CONSEQUENCES: readonly Consequence[] = [
  ...
  consequence("blackboard.submit", "critical", true, "Uploads and submits an assignment attempt.", "The wrong file or assignment can affect grading and may consume an attempt.", "Read attempt count and submitted filename back from Blackboard.", "unavailable"),
