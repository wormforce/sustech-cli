...
export const CAPABILITIES: readonly Capability[] = [
  ...
  capability("tis plan init", "Create or replace a local persistent timetable-planning file.", "local", { network: false, status: "preview" }),
  capability("tis plan show", "Inspect the local persistent timetable-planning file.", "local", { network: false, status: "preview" }),
  capability("tis plan add", "Add course codes or blocked periods to the local persistent timetable plan.", "local", { network: false, status: "preview" }),
  ...
  capability("tis plan solve", "Solve a saved local timetable plan against the live catalog with scored ranking.", "plan", { authentication: "tis", status: "preview" }),
