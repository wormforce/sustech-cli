...
export const CAPABILITIES: readonly Capability[] = [
  ...
  capability("booking create preview", "Run live read-only checks for one exact eHall room reservation target and emit a confirmed apply handoff.", "plan", { authentication: "booking", status: "preview" }),
  capability("booking create apply", "Create one exact eHall room reservation after live revalidation.", "mutation", { authentication: "booking", confirmation: "required", status: "preview" }),
  ...
  capability("lib-booking create preview", "Run live read-only checks for one exact IC library reservation target and emit a confirmed apply handoff.", "plan", { authentication: "lib-booking", status: "preview" }),
  capability("lib-booking create apply", "Create one exact IC library reservation after live revalidation.", "mutation", { authentication: "lib-booking", confirmation: "required", status: "preview" }),
