...
export const CAPABILITIES: readonly Capability[] = [
  ...
  capability("booking create preview", "Run live inventory and policy checks for one intended eHall room reservation target and emit a confirmed apply handoff; exact slot availability is not verified.", "plan", { authentication: "booking", status: "preview" }),
  ...
  capability("lib-booking create preview", "Run live inventory, membership, and policy checks for one intended IC library reservation target and emit a confirmed apply handoff; exact slot availability is not verified.", "plan", { authentication: "lib-booking", status: "preview" }),
